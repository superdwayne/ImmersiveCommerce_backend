...
app.get('/api/models', (req, res) => {
    const models = [
        ...
        },
        {
            ...
            usdzUrl: "https://immersive-commerce.vercel.app/models/bag.usdz"
        },
        {
            name: "Dior",
            glbUrl: "https://storage.polycam.io/captures/d330c813-0232-4620-b394-642145be55eb/raw.glb?t=1729077933033",
            usdzUrl: "https://immersive-commerce.vercel.app/models/dior.usdz"
        }
    ];
    res.json(models);
});
